...
// inputs: numero de ips (min 1), top (value 0.92, step 0.01, min 0, max 1), bottom (value 0.3, step 0.01, min 0, max 1)
export default function ScoreAverage({ data, period, numIps }) {
