...
// inputs: ip, tipo de gráfico (location, reports, score_average, last_report, time_period, ibm_scores, virustotal_stats)

// location: abuseipdb_country_code, abuseipdb_isp, abuseipdb_domain, virustotal_as_owner, virustotal_asn, ALIENVAULT_asn
export default function Comportamento({ ip, chartType }) {
